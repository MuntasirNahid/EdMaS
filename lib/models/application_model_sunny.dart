...
class ApplicationModelSunny {
  ...
  ApplicationModelSunny copyWith({
    String? id,
    String? applicantId,
  ...
  factory ApplicationModelSunny.fromMap(Map<String, dynamic> map) {
    return ApplicationModelSunny(
      id: map['id'] as String,
  ...
  factory ApplicationModelSunny.fromJson(String source) =>
      ApplicationModelSunny.fromMap(
  ...
  @override
  bool operator ==(covariant ApplicationModelSunny other) {
